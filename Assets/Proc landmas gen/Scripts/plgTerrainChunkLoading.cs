...
public class plgTerrainChunkLoading : MonoBehaviour
{
    ...
    static plgMapGenerator mapGenerator;
    int chunkSize;
    ...
    public class TerrainChunk
    {
        ...
        void OnMapDataReceived(MapData mapData)
        {
            ...
            Texture2D texture = plgTextureGenerator.TextureFromColourMap(mapData.colourMap, plgMapGenerator.mapChunkSize, plgMapGenerator.mapChunkSize);
